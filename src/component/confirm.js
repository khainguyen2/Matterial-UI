        ...
        <Box className={classes.confirm} >
            <Box className={classes.confirm__width} >
                ...
                <Grid container spacing={2}>
                    <Grid item md={10} mc={12} sm={10} xs={12} className={classes.order__box} >
                        <Box className={classes.content__padding}>
                            <Box className={classes.fontWeight}>Đơn mới</Box>
                            <Box>
                                <Grid container spacing={3} >
                                    <Grid item xs={6}>
                    ...
                    <Grid item md={10} sm={12} xs={12} className={classes.order__box__2} ml={1} >
                        <Box className={classes.content__padding}>
                            <Box className={classes.fontWeight}>Đơn mới</Box>
                            <Box>
                                <Grid container spacing={3} >
                    ...
                    <Grid item xs={12} sm={2}>
                        <Grid container spacing={1} className={classes.order__btn__2}>
